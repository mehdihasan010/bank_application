...
class _WalletScreen2State extends State<WalletScreen2> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
                      ...
                      return Builder(
                        builder: (BuildContext context) {
                          return _buildCreditCard(
                            ...
                            category: card
                                .cardType, // You can add category field if needed
                          );
                        },
                      );
                    }).toList(),
          ...
          _buildDotsIndicator(cards.length),
          const SizedBox(height: 10),
          _buildActionsRow(),
          const SizedBox(height: 10),
          const Padding(
  ...
  Row _buildDotsIndicator(int item) {
    return Row(
  ...
  Card _buildCreditCard({
    ...
    return Card(
      color:
          category == 'MC' ? color : const Color(0xFF0d233a).withOpacity(0.6),
